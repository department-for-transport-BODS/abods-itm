...
FROM (VALUES %s) AS t(timetable_id, time_difference, last_time_in_zone_str, group_id, batch_id, last_time_in_zone_utc, otp_state, is_final_stop, journey_date, timestamp_after_estimate)
