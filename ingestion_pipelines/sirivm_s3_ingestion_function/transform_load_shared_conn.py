...
def parse_xml(source, batch_id, source_type='string'):
    ...
    for vehicle_activity in root.findall('.//siri:VehicleActivity', NS):
        ...
        extracted_data = extract_data(vehicle_activity, service_delivery_timestamp, batch_id)
...
def extract_data(vehicle_activity, service_delivery_timestamp, batch_id):
    ...
    return recorded_at_time, response_timestamp, latitude, longitude, line_name, operator_ref, vehicle_ref, journey_ref, direction_ref, date_of_journey, batch_id
