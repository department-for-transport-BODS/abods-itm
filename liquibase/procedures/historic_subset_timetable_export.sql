create or replace procedure historic_subset_timetable_export(IN partition_date date, IN list_group_ids text[])
    language plpgsql
as
$$
DECLARE
...
alter procedure historic_subset_timetable_export owner to abods_proxy_rw;
DROP PROCEDURE IF EXISTS historic_subset_timetable_export;