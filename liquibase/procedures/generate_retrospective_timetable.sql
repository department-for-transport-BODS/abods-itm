create or replace procedure generate_retrospective_timetable(IN partition_date date)
    language plpgsql
as
$$
...
MaxStartDates as (
	...
	from (
		...
		join (
				...
				or (os.registration_status != ''Registered'' and os.registration_status != '''' and os.effective_date > %L::date + 1)
	    ) osn
...
alter procedure generate_retrospective_timetable owner to abods_proxy_rw;
