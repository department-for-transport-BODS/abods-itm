SELECT cron.schedule(
               ...
               '00 01 * * *', -- at 01:00
               $$CALL public.populate_headway(CURRENT_DATE - 2);CALL public.populate_headway(CURRENT_DATE - 1);CALL public.incomplete_data_load(CURRENT_DATE - 2);populate_avl_recorded_expected_journeys(CURRENT_DATE - 2);CALL public.incomplete_data_load(CURRENT_DATE - 1);populate_avl_recorded_expected_journeys(CURRENT_DATE - 1);$$
       );
