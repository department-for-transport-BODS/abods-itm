ALTER TABLE if exists public.transmodel_vehiclejourney ALTER COLUMN block_number TYPE text USING block_number::text;

ALTER TABLE if exists public.transmodel_servicepatternstop ADD COLUMN if not exists auto_sequence_number int4 NULL;
