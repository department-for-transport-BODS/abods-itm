------ CREATE PARTITIONS, POPULATE AND SCHEDULE THE PROCEDURE FOR SUMMARY BY SERVICE TABLE ----------


CREATE OR REPLACE PROCEDURE public.create_partition_summary_service()
LANGUAGE 'plpgsql'
AS $BODY$
DECLARE   
...
ALTER PROCEDURE public.create_partition_summary_service()
    OWNER TO abods_rw;

-- CHANGE OWNERSHIP 

SELECT cron.schedule('create_partition_summary_service', 
	'10 2 * * *', $$CALL public.create_partition_summary_service()$$);
